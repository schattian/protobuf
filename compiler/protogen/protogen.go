...
import (
	...
	"github.com/schattian/protobuf/reflect/protodesc"
...
func (opts Options) New(req *pluginpb.CodeGeneratorRequest) (*Plugin, error) {
	...
	//
	//     option go_package = "github.com/schattian/protobuf/types/known/anypb";
	//
...
// For example: "github.com/schattian/protobuf/compiler/protogen"
